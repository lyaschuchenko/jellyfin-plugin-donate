...
1. Go to **Dashboard** -> **Plugins** -> **Donate** and enter your full donation URL (e.g., https://send.monobank.ua/... or your BuyMeACoffee link). Click Save.
...
* Updated to .NET 9 and refactored for universal donation platform support and UI DOM injection in this fork.
